...
namespace EB
{
    public partial class resistencia : Form
    {
        ...
        private void amarillo3ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void violeta6ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void negro0ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void rojo2ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            button5.Enabled = true;
        ...
        private void violeta7ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            button5.Enabled = true;
        ...
        private void gris8ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            button5.Enabled = true;
        ...
        private void blanco9ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            button5.Enabled = true;
        ...
        private void verde4ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            button1.Enabled = true;
        ...
        private void azul5ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            button1.Enabled = true;
       ...
       /* bool d = true;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (banda3 == 10 || banda3 == 100 || banda3 == 1000)
            {
                y = y / 1; /*label2.Text = "K Ohm"; */
            }
